...
public:
	...
	void setSerial(HardwareSerial &serial);
        ...
        //! Timing variables for performance profilling, C. Pham
        /*!
         */
        long startSend;
        long stopSend;
        ...
        long startWriteLoop;
        long stopWriteLoop;
        long startParseMessage;
        long stopParseMessage;
        long startTxStatusResponse;
        long stopTxStatusResponse;
        long startFetchedTime;
        long stopFetchedTime;
